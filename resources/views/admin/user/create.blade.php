        ...
        <div class="">
            ...
            <div class="row" style="min-height:500px">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2 style="color: #1b4b72">Add new user</h2>
                        ...
                        <div class="x_content">
                            <form method="post" action="{{action('Admin\UserController@store')}}" class="col-md-10 col-md-offset-2">
                                {{ csrf_field() }}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 col-md-offset-3">
                                        <input type="submit" class="btn btn-success pull-right" value="Add User" style="margin-right: 10%">
                                    </div>
                                </div>
                            </form>
                        </div>
